...
class About extends Component {
  ...
  render() {
    return (
      <div className="about-page" style={{backgroundImage: "url(/images/banner/grapes-3550733_1920.jpg)"}}>
        <div className="jumbotron">
          ...
          <p className="lead-btn">
            <button onClick={this.handleButtonClick} className="btn btn-dark btn-lg contact-btn">
              Contact us
            </button>
          </p>
        </div>
